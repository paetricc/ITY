...
\begin{frame}\frametitle{Příklad BFS algoritmu}
    \begin{figure}
        \includegraphics<1>[height=170pt]                {ITY1.pdf}
        \includegraphics<2>[height=170pt,trim={ 4 0 0 0}]{ITY2.pdf}
        \includegraphics<3>[height=170pt,trim={ 8 0 0 0}]{ITY3.pdf}
        \includegraphics<4>[height=170pt,trim={12 0 0 0}]{ITY4.pdf}
        \includegraphics<5>[height=170pt,trim={16 0 0 0}]{ITY5.pdf}
        \includegraphics<6>[height=170pt,trim={20 0 0 0}]{ITY6.pdf}
        \includegraphics<7>[height=170pt,trim={24 0 0 0}]{ITY7.pdf}
        \includegraphics<8>[height=170pt,trim={28 0 0 0}]{ITY8.pdf}
    \end{figure}
    \only<1>{$Q=s$}
    \only<2>{$Q=tr$}
    \only<3>{$Q=rvu$}
