...
\begin{quotation}
Čím více \texttt{druhů}, \emph{řezů}, {\tiny velikostí}, \green{barev} písma a \textsc{\blue{jiných efektů}} \underline{použijeme}, \red{tím profesionálněji} bude {\fontfamily{pzc}\selectfont dokument} vypadat.
